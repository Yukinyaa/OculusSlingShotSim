...
public class LocomotionTeleport : MonoBehaviour
{
	...
	/// <summary>
	/// Override the TeleportDestinationFactory with your own pool manager if necessary.
	/// </summary>
	/// <returns></returns>
	protected virtual TeleportDestination TeleportDestinationFactory()
	{
		...
		return GameObject.Instantiate(TeleportDestinationPrefab);
	}

	/// <summary>
	/// Override the TeleportDestinationRecycler with your own pool manager if necessary.
	/// </summary>
	/// <param name="obj"></param>
	protected virtual void TeleportDestinationRecycler(TeleportDestination obj)
	{
	...
	{
		_teleportDestination = TeleportDestinationFactory();
	...
	/// <summary>
	/// Recycle the destination object. In the basic implementation, this just destroys the object however if there
	/// is an object pooling system then the TeleportDestinationRecycler should be overridden to use it.
	/// </summary>
	/// <param name="oldDestination"></param>
	public void RecycleTeleportDestination(TeleportDestination oldDestination)
	{
		...
		TeleportDestinationRecycler(oldDestination);
	}
